...
class ServiceAudioManager:
    ...
    def trigger_alarm(self, task: Task, *args: Any, **kwargs: Any) -> None:
        ...
        with self._lock:
            ...
            # No alarm set
                ...
                logger.trace("No alarm set, skipping alarm playback")
            ...
            # No vibrate set
                ...
                logger.trace("No vibrate set, skipping vibrate")
        ...
        while not self._alarm_stop_event.is_set() and self.task and self.task.keep_alarming:
            try:
                ...
                if not path:
                    ...
                    if not path:
                        logger.error("Alarm loop called with no alarm set")
                        break
    ...
    def play_audio(self, path: str) -> bool:
        ...
        try:
            ...
            logger.trace(f"Started playback: {path}")
            return True
    ...
    def get_audio_path(self, name: str | None) -> str | None:
        ...
        If name is None, Task has no alarm set.
        """
        if name is None:
            return None
